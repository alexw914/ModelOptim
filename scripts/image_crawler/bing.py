...
if __name__ == '__main__':
    ...
    parser.add_argument("--word", type=str, help="抓取关键词", required=True)
    parser.add_argument("--nums", type=int, help="需要抓取的图片数量", required=True)
    parser.add_argument("--local_path", type=str, default="bing", help="下载路径")
    args = parser.parse_args()

    BingImagesSpider(args.word, 500, args.local_path).run()